...
import com.shanlian.genetic.api.persistentcookiejar.BaseApiRetrofit;
...
//        RequestBody body = RequestBody.create(okhttp3.MediaType.parse("application/json; charset=utf-8"), route);
    ...
    public Observable<String> login( LoginRequest loginRequest) {
        return mApi.login(getRequestBody(loginRequest));
    }

    //注册
    public Observable<String> Register(RegisterRequest registerRequest) {
        return mApi.register(getRequestBody(registerRequest));
    }
